  POSCAR-TB
  1 1 1  0 0 0                               # nx,ny,nz
  1  B1   1.20   0.9 0.2 0.1 0.9           # atom number,atom species,bond length,color
  1  B2   1.20   0.9 0.2 0.1 0.9           # atom number,atom species,bond length,color
  0.03           0.5 0.5 0.5            # bond width,color
  0                                     # bounding box, 0: off, 1: x, 2:y, 3:z, 4: all 
  12 20                                 # bounding box, for 1~3: single line "min" to "max"

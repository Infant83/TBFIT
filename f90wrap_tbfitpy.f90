...
subroutine f90wrap_init(comm, pinpt_py, ppram_py, pkpts_py, pwght_py, pgeom_py, nn_table_py, edft_py, etba_py)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, weight_py, incar_py, hopping_py, init
    implicit none
...
subroutine f90wrap_fit(comm, pinpt_py, ppram_py, pkpts_py, pwght_py, pgeom_py, nn_table_py, edft_py, etba_py)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, weight_py, incar_py, hopping_py, fit
    implicit none
...
! End of module pyfit defined in file tbfitpy.f90

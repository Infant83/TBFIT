...
subroutine f90wrap_incar_py__get__flag_print_proj_atom(this, f90wrap_flag_print_proj_atom)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_print_proj_atom
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_print_proj_atom = this_ptr%p%flag_print_proj_atom
end subroutine f90wrap_incar_py__get__flag_print_proj_atom

subroutine f90wrap_incar_py__set__flag_print_proj_atom(this, f90wrap_flag_print_proj_atom)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_print_proj_atom
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_print_proj_atom = f90wrap_flag_print_proj_atom
end subroutine f90wrap_incar_py__set__flag_print_proj_atom
...
subroutine f90wrap_incar_py__get__flag_fit_orbital_parse(this, f90wrap_flag_fit_orbital_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_fit_orbital_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_fit_orbital_parse = this_ptr%p%flag_fit_orbital_parse
end subroutine f90wrap_incar_py__get__flag_fit_orbital_parse

subroutine f90wrap_incar_py__set__flag_fit_orbital_parse(this, f90wrap_flag_fit_orbital_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_fit_orbital_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_fit_orbital_parse = f90wrap_flag_fit_orbital_parse
end subroutine f90wrap_incar_py__set__flag_fit_orbital_parse

subroutine f90wrap_incar_py__get__flag_pfile_parse(this, f90wrap_flag_pfile_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_pfile_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_pfile_parse = this_ptr%p%flag_pfile_parse
end subroutine f90wrap_incar_py__get__flag_pfile_parse

subroutine f90wrap_incar_py__set__flag_pfile_parse(this, f90wrap_flag_pfile_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_pfile_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_pfile_parse = f90wrap_flag_pfile_parse
end subroutine f90wrap_incar_py__set__flag_pfile_parse

subroutine f90wrap_incar_py__get__flag_reduce_hopping_parse(this, f90wrap_flag_reduce_hopping_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_reduce_hopping_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_reduce_hopping_parse = this_ptr%p%flag_reduce_hopping_parse
end subroutine f90wrap_incar_py__get__flag_reduce_hopping_parse

subroutine f90wrap_incar_py__set__flag_reduce_hopping_parse(this, f90wrap_flag_reduce_hopping_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_reduce_hopping_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_reduce_hopping_parse = f90wrap_flag_reduce_hopping_parse
end subroutine f90wrap_incar_py__set__flag_reduce_hopping_parse

subroutine f90wrap_incar_py__get__flag_reduce_overlap_parse(this, f90wrap_flag_reduce_overlap_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_reduce_overlap_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_reduce_overlap_parse = this_ptr%p%flag_reduce_overlap_parse
end subroutine f90wrap_incar_py__get__flag_reduce_overlap_parse

subroutine f90wrap_incar_py__set__flag_reduce_overlap_parse(this, f90wrap_flag_reduce_overlap_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_reduce_overlap_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_reduce_overlap_parse = f90wrap_flag_reduce_overlap_parse
end subroutine f90wrap_incar_py__set__flag_reduce_overlap_parse

subroutine f90wrap_incar_py__get__flag_pso_with_lmdif(this, f90wrap_flag_pso_with_lmdif)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_pso_with_lmdif
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_pso_with_lmdif = this_ptr%p%flag_pso_with_lmdif
end subroutine f90wrap_incar_py__get__flag_pso_with_lmdif

subroutine f90wrap_incar_py__set__flag_pso_with_lmdif(this, f90wrap_flag_pso_with_lmdif)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_pso_with_lmdif
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_pso_with_lmdif = f90wrap_flag_pso_with_lmdif
end subroutine f90wrap_incar_py__set__flag_pso_with_lmdif

subroutine f90wrap_incar_py__get__flag_get_unfold(this, f90wrap_flag_get_unfold)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_get_unfold
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_get_unfold = this_ptr%p%flag_get_unfold
end subroutine f90wrap_incar_py__get__flag_get_unfold

subroutine f90wrap_incar_py__set__flag_get_unfold(this, f90wrap_flag_get_unfold)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_get_unfold
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_get_unfold = f90wrap_flag_get_unfold
end subroutine f90wrap_incar_py__set__flag_get_unfold
...
subroutine f90wrap_incar_py__get__ls_type(this, f90wrap_ls_type)
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    character(10), intent(out) :: f90wrap_ls_type
...
subroutine f90wrap_incar_py__set__ls_type(this, f90wrap_ls_type)
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    character(10), intent(in) :: f90wrap_ls_type
...
subroutine f90wrap_incar_py__get__pfilenm_parse(this, f90wrap_pfilenm_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    character(132), intent(out) :: f90wrap_pfilenm_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pfilenm_parse = this_ptr%p%pfilenm_parse
end subroutine f90wrap_incar_py__get__pfilenm_parse

subroutine f90wrap_incar_py__set__pfilenm_parse(this, f90wrap_pfilenm_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    character(132), intent(in) :: f90wrap_pfilenm_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pfilenm_parse = f90wrap_pfilenm_parse
end subroutine f90wrap_incar_py__set__pfilenm_parse
...
subroutine f90wrap_incar_py__get__reduce_hopping_parse(this, f90wrap_reduce_hopping_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_reduce_hopping_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_reduce_hopping_parse = this_ptr%p%reduce_hopping_parse
end subroutine f90wrap_incar_py__get__reduce_hopping_parse

subroutine f90wrap_incar_py__set__reduce_hopping_parse(this, f90wrap_reduce_hopping_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_reduce_hopping_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%reduce_hopping_parse = f90wrap_reduce_hopping_parse
end subroutine f90wrap_incar_py__set__reduce_hopping_parse

subroutine f90wrap_incar_py__get__reduce_overlap_parse(this, f90wrap_reduce_overlap_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_reduce_overlap_parse
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_reduce_overlap_parse = this_ptr%p%reduce_overlap_parse
end subroutine f90wrap_incar_py__get__reduce_overlap_parse

subroutine f90wrap_incar_py__set__reduce_overlap_parse(this, f90wrap_reduce_overlap_parse)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_reduce_overlap_parse
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%reduce_overlap_parse = f90wrap_reduce_overlap_parse
end subroutine f90wrap_incar_py__set__reduce_overlap_parse

subroutine f90wrap_incar_py__get__orbital_fit_smearing(this, f90wrap_orbital_fit_smearing)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_orbital_fit_smearing
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_orbital_fit_smearing = this_ptr%p%orbital_fit_smearing
end subroutine f90wrap_incar_py__get__orbital_fit_smearing

subroutine f90wrap_incar_py__set__orbital_fit_smearing(this, f90wrap_orbital_fit_smearing)
    use pyfit, only: incar_py
    implicit none
    type incar_py_ptr_type
        type(incar_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(incar_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_orbital_fit_smearing
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%orbital_fit_smearing = f90wrap_orbital_fit_smearing
end subroutine f90wrap_incar_py__set__orbital_fit_smearing
...
subroutine f90wrap_params_py__get__flag_fit_plain(this, f90wrap_flag_fit_plain)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    logical, intent(out) :: f90wrap_flag_fit_plain
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_flag_fit_plain = this_ptr%p%flag_fit_plain
end subroutine f90wrap_params_py__get__flag_fit_plain

subroutine f90wrap_params_py__set__flag_fit_plain(this, f90wrap_flag_fit_plain)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    logical, intent(in) :: f90wrap_flag_fit_plain
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%flag_fit_plain = f90wrap_flag_fit_plain
end subroutine f90wrap_params_py__set__flag_fit_plain
...
subroutine f90wrap_params_py__get__reduce_overlap(this, f90wrap_reduce_overlap)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_reduce_overlap
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_reduce_overlap = this_ptr%p%reduce_overlap
end subroutine f90wrap_params_py__get__reduce_overlap

subroutine f90wrap_params_py__set__reduce_overlap(this, f90wrap_reduce_overlap)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_reduce_overlap
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%reduce_overlap = f90wrap_reduce_overlap
end subroutine f90wrap_params_py__set__reduce_overlap

subroutine f90wrap_params_py__get__reduce_hopping(this, f90wrap_reduce_hopping)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_reduce_hopping
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_reduce_hopping = this_ptr%p%reduce_hopping
end subroutine f90wrap_params_py__get__reduce_hopping

subroutine f90wrap_params_py__set__reduce_hopping(this, f90wrap_reduce_hopping)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_reduce_hopping
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%reduce_hopping = f90wrap_reduce_hopping
end subroutine f90wrap_params_py__set__reduce_hopping

subroutine f90wrap_params_py__get__pso_c1(this, f90wrap_pso_c1)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_pso_c1
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_c1 = this_ptr%p%pso_c1
end subroutine f90wrap_params_py__get__pso_c1

subroutine f90wrap_params_py__set__pso_c1(this, f90wrap_pso_c1)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_pso_c1
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_c1 = f90wrap_pso_c1
end subroutine f90wrap_params_py__set__pso_c1

subroutine f90wrap_params_py__get__pso_c2(this, f90wrap_pso_c2)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_pso_c2
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_c2 = this_ptr%p%pso_c2
end subroutine f90wrap_params_py__get__pso_c2

subroutine f90wrap_params_py__set__pso_c2(this, f90wrap_pso_c2)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_pso_c2
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_c2 = f90wrap_pso_c2
end subroutine f90wrap_params_py__set__pso_c2

subroutine f90wrap_params_py__get__pso_w(this, f90wrap_pso_w)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_pso_w
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_w = this_ptr%p%pso_w
end subroutine f90wrap_params_py__get__pso_w

subroutine f90wrap_params_py__set__pso_w(this, f90wrap_pso_w)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_pso_w
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_w = f90wrap_pso_w
end subroutine f90wrap_params_py__set__pso_w

subroutine f90wrap_params_py__get__pso_max_noise_amplitude(this, f90wrap_pso_max_noise_amplitude)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(out) :: f90wrap_pso_max_noise_amplitude
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_max_noise_amplitude = this_ptr%p%pso_max_noise_amplitude
end subroutine f90wrap_params_py__get__pso_max_noise_amplitude

subroutine f90wrap_params_py__set__pso_max_noise_amplitude(this, f90wrap_pso_max_noise_amplitude)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    real(8), intent(in) :: f90wrap_pso_max_noise_amplitude
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_max_noise_amplitude = f90wrap_pso_max_noise_amplitude
end subroutine f90wrap_params_py__set__pso_max_noise_amplitude

subroutine f90wrap_params_py__get__pso_miter(this, f90wrap_pso_miter)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(out) :: f90wrap_pso_miter
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_miter = this_ptr%p%pso_miter
end subroutine f90wrap_params_py__get__pso_miter

subroutine f90wrap_params_py__set__pso_miter(this, f90wrap_pso_miter)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(in) :: f90wrap_pso_miter
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_miter = f90wrap_pso_miter
end subroutine f90wrap_params_py__set__pso_miter
...
subroutine f90wrap_params_py__get__pso_nparticles(this, f90wrap_pso_nparticles)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(out) :: f90wrap_pso_nparticles
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_pso_nparticles = this_ptr%p%pso_nparticles
end subroutine f90wrap_params_py__get__pso_nparticles

subroutine f90wrap_params_py__set__pso_nparticles(this, f90wrap_pso_nparticles)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(in) :: f90wrap_pso_nparticles
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%pso_nparticles = f90wrap_pso_nparticles
end subroutine f90wrap_params_py__set__pso_nparticles
...
subroutine f90wrap_params_py__array__param_best(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%param_best)) then
        dshape(1:1) = shape(this_ptr%p%param_best)
        dloc = loc(this_ptr%p%param_best)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__param_best
...
subroutine f90wrap_params_py__array__iparam_type(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 5
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%iparam_type)) then
        dshape(1:1) = shape(this_ptr%p%iparam_type)
        dloc = loc(this_ptr%p%iparam_type)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__iparam_type

subroutine f90wrap_params_py__array__iparam_type_free(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 5
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%iparam_type_free)) then
        dshape(1:1) = shape(this_ptr%p%iparam_type_free)
        dloc = loc(this_ptr%p%iparam_type_free)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__iparam_type_free
...
subroutine f90wrap_params_py__array__pso_cost_history(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%pso_cost_history)) then
        dshape(1:1) = shape(this_ptr%p%pso_cost_history)
        dloc = loc(this_ptr%p%pso_cost_history)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__pso_cost_history

subroutine f90wrap_params_py__array__pso_cost_history_i(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%pso_cost_history_i)) then
        dshape(1:2) = shape(this_ptr%p%pso_cost_history_i)
        dloc = loc(this_ptr%p%pso_cost_history_i)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__pso_cost_history_i

subroutine f90wrap_params_py__array__pso_pbest_history(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%pso_pbest_history)) then
        dshape(1:3) = shape(this_ptr%p%pso_pbest_history)
        dloc = loc(this_ptr%p%pso_pbest_history)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__pso_pbest_history

subroutine f90wrap_params_py__array__cost_history(this, nd, dtype, dshape, dloc)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%cost_history)) then
        dshape(1:1) = shape(this_ptr%p%cost_history)
        dloc = loc(this_ptr%p%cost_history)
    else
        dloc = 0
    end if
end subroutine f90wrap_params_py__array__cost_history

subroutine f90wrap_params_py__get__niter(this, f90wrap_niter)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(out) :: f90wrap_niter
    
    this_ptr = transfer(this, this_ptr)
    f90wrap_niter = this_ptr%p%niter
end subroutine f90wrap_params_py__get__niter

subroutine f90wrap_params_py__set__niter(this, f90wrap_niter)
    use pyfit, only: params_py
    implicit none
    type params_py_ptr_type
        type(params_py), pointer :: p => NULL()
    ...
    integer, intent(in)   :: this(2)
    type(params_py_ptr_type) :: this_ptr
    integer(4), intent(in) :: f90wrap_niter
    
    this_ptr = transfer(this, this_ptr)
    this_ptr%p%niter = f90wrap_niter
end subroutine f90wrap_params_py__set__niter
...
subroutine f90wrap_kpoints_py__get__kline_type(this, f90wrap_kline_type)
    ...
    integer, intent(in)   :: this(2)
    type(kpoints_py_ptr_type) :: this_ptr
    character(8), intent(out) :: f90wrap_kline_type
...
subroutine f90wrap_kpoints_py__set__kline_type(this, f90wrap_kline_type)
    ...
    integer, intent(in)   :: this(2)
    type(kpoints_py_ptr_type) :: this_ptr
    character(8), intent(in) :: f90wrap_kline_type
...
subroutine f90wrap_kpoints_py__get__kunit(this, f90wrap_kunit)
    ...
    integer, intent(in)   :: this(2)
    type(kpoints_py_ptr_type) :: this_ptr
    character(1), intent(out) :: f90wrap_kunit
...
subroutine f90wrap_kpoints_py__set__kunit(this, f90wrap_kunit)
    ...
    integer, intent(in)   :: this(2)
    type(kpoints_py_ptr_type) :: this_ptr
    character(1), intent(in) :: f90wrap_kunit
...
subroutine f90wrap_weight_py__get__efile_type(this, f90wrap_efile_type)
    ...
    integer, intent(in)   :: this(2)
    type(weight_py_ptr_type) :: this_ptr
    character(16), intent(out) :: f90wrap_efile_type
...
subroutine f90wrap_weight_py__set__efile_type(this, f90wrap_efile_type)
    ...
    integer, intent(in)   :: this(2)
    type(weight_py_ptr_type) :: this_ptr
    character(16), intent(in) :: f90wrap_efile_type
...
subroutine f90wrap_poscar_py__array__c_orbital(this, nd, dtype, dshape, dloc)
    use pyfit, only: poscar_py
    implicit none
    type poscar_py_ptr_type
        type(poscar_py), pointer :: p => NULL()
    ...
    dtype = 2
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%c_orbital)) then
        dshape(1:3) = (/len(this_ptr%p%c_orbital(1,1)), shape(this_ptr%p%c_orbital)/)
        dloc = loc(this_ptr%p%c_orbital)
    else
        dloc = 0
    end if
end subroutine f90wrap_poscar_py__array__c_orbital

subroutine f90wrap_poscar_py__array__c_spec(this, nd, dtype, dshape, dloc)
    use pyfit, only: poscar_py
    implicit none
    type poscar_py_ptr_type
        type(poscar_py), pointer :: p => NULL()
    ...
    dtype = 2
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%c_spec)) then
        dshape(1:2) = (/len(this_ptr%p%c_spec(1)), shape(this_ptr%p%c_spec)/)
        dloc = loc(this_ptr%p%c_spec)
    else
        dloc = 0
    end if
end subroutine f90wrap_poscar_py__array__c_spec
...
subroutine f90wrap_poscar_py__array__spec(this, nd, dtype, dshape, dloc)
    use pyfit, only: poscar_py
    implicit none
    type poscar_py_ptr_type
        type(poscar_py), pointer :: p => NULL()
    ...
    if (allocated(this_ptr%p%spec)) then
        dshape(1:1) = shape(this_ptr%p%spec)
        dloc = loc(this_ptr%p%spec)
    else
        dloc = 0
    end if
end subroutine f90wrap_poscar_py__array__spec
...
subroutine f90wrap_hopping_py__array__Dijc(this, nd, dtype, dshape, dloc)
    use pyfit, only: hopping_py
    implicit none
    type hopping_py_ptr_type
        type(hopping_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%Dijc)) then
        dshape(1:1) = shape(this_ptr%p%Dijc)
        dloc = loc(this_ptr%p%Dijc)
    else
        dloc = 0
    end if
end subroutine f90wrap_hopping_py__array__Dijc
...
subroutine f90wrap_energy_py__array__dORB(this, nd, dtype, dshape, dloc)
    use pyfit, only: energy_py
    implicit none
    type energy_py_ptr_type
        type(energy_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%dORB)) then
        dshape(1:2) = shape(this_ptr%p%dORB)
        dloc = loc(this_ptr%p%dORB)
    else
        dloc = 0
    end if
end subroutine f90wrap_energy_py__array__dORB
...
subroutine f90wrap_energy_py__array__V2(this, nd, dtype, dshape, dloc)
    use pyfit, only: energy_py
    implicit none
    type energy_py_ptr_type
        type(energy_py), pointer :: p => NULL()
    ...
    dtype = 12
    this_ptr = transfer(this, this_ptr)
    if (allocated(this_ptr%p%V2)) then
        dshape(1:3) = shape(this_ptr%p%V2)
        dloc = loc(this_ptr%p%V2)
    else
        dloc = 0
    end if
end subroutine f90wrap_energy_py__array__V2
...
subroutine f90wrap_init5(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, init5, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py
    implicit none
...
subroutine f90wrap_init4(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py, init4
    implicit none
...
subroutine f90wrap_init3(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, init3, incar_py, hopping_py, weight_py
    implicit none
    ...
    edft_py3_ptr = transfer(edft_py3, edft_py3_ptr)
    etba_py3_ptr = transfer(etba_py3, etba_py3_ptr)
    call init3(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, PKPTS_PY3=pkpts_py3_ptr%p, &
        PWGHT_PY3=pwght_py3_ptr%p, PGEOM_PY3=pgeom_py3_ptr%p, NN_TABLE_PY3=nn_table_py3_ptr%p, EDFT_PY3=edft_py3_ptr%p, &
        ETBA_PY3=etba_py3_ptr%p, pfilenm_parse=pfilenm_parse)
end subroutine f90wrap_init3
...
subroutine f90wrap_init2(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, init2, weight_py
    implicit none
    ...
    edft_py2_ptr = transfer(edft_py2, edft_py2_ptr)
    etba_py2_ptr = transfer(etba_py2, etba_py2_ptr)
    call init2(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, pfilenm_parse=pfilenm_parse)
...
subroutine f90wrap_init(comm, pinpt_py, ppram_py, pkpts_py, pwght_py, pgeom_py, nn_table_py, edft_py, etba_py, &
    pfilenm_parse)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, init, weight_py
    implicit none
...
subroutine f90wrap_pso5(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py, pso5
    implicit none
...
subroutine f90wrap_pso4(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, pso4, weight_py
    implicit none
...
subroutine f90wrap_pso3(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py, pso3
    implicit none
    ...
    edft_py3_ptr = transfer(edft_py3, edft_py3_ptr)
    etba_py3_ptr = transfer(etba_py3, etba_py3_ptr)
    call pso3(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, PKPTS_PY3=pkpts_py3_ptr%p, &
        PWGHT_PY3=pwght_py3_ptr%p, PGEOM_PY3=pgeom_py3_ptr%p, NN_TABLE_PY3=nn_table_py3_ptr%p, EDFT_PY3=edft_py3_ptr%p, &
        ETBA_PY3=etba_py3_ptr%p, iseed=iseed, pso_miter=pso_miter)
end subroutine f90wrap_pso3
...
subroutine f90wrap_pso2(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, pso2, weight_py
    implicit none
    ...
    edft_py2_ptr = transfer(edft_py2, edft_py2_ptr)
    etba_py2_ptr = transfer(etba_py2, etba_py2_ptr)
    call pso2(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, iseed=iseed, pso_miter=pso_miter)
end subroutine f90wrap_pso2

subroutine f90wrap_pso(comm, pinpt_py, ppram_py, pkpts_py, pwght_py, pgeom_py, nn_table_py, edft_py, etba_py, iseed, &
    pso_miter)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py, pso
    implicit none
    ...
    edft_py_ptr = transfer(edft_py, edft_py_ptr)
    etba_py_ptr = transfer(etba_py, etba_py_ptr)
    call pso(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY=pkpts_py_ptr%p, PWGHT_PY=pwght_py_ptr%p, &
        PGEOM_PY=pgeom_py_ptr%p, NN_TABLE_PY=nn_table_py_ptr%p, EDFT_PY=edft_py_ptr%p, ETBA_PY=etba_py_ptr%p, iseed=iseed, &
        pso_miter=pso_miter)
...
subroutine f90wrap_eig5(comm, pinpt_py, ppram_py, pkpts_py, pgeom_py, nn_table_py, etba_py, pkpts_py2, pgeom_py2, &
    ...
    use pyfit, only: params_py, energy_py, eig5, kpoints_py, poscar_py, hopping_py, incar_py
    implicit none
...
subroutine f90wrap_eig4(comm, pinpt_py, ppram_py, pkpts_py, pgeom_py, nn_table_py, etba_py, pkpts_py2, pgeom_py2, &
    nn_table_py2, etba_py2, pkpts_py3, pgeom_py3, nn_table_py3, etba_py3, pkpts_py4, pgeom_py4, nn_table_py4, etba_py4)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, eig4, incar_py
    implicit none
...
subroutine f90wrap_eig3(comm, pinpt_py, ppram_py, pkpts_py, pgeom_py, nn_table_py, etba_py, pkpts_py2, pgeom_py2, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, eig3
    implicit none
    ...
    nn_table_py3_ptr = transfer(nn_table_py3, nn_table_py3_ptr)
    etba_py3_ptr = transfer(etba_py3, etba_py3_ptr)
    call eig3(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY=pkpts_py_ptr%p, PGEOM_PY=pgeom_py_ptr%p, &
        NN_TABLE_PY=nn_table_py_ptr%p, ETBA_PY=etba_py_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, PKPTS_PY3=pkpts_py3_ptr%p, PGEOM_PY3=pgeom_py3_ptr%p, &
        NN_TABLE_PY3=nn_table_py3_ptr%p, ETBA_PY3=etba_py3_ptr%p)
end subroutine f90wrap_eig3
...
subroutine f90wrap_eig2(comm, pinpt_py, ppram_py, pkpts_py, pgeom_py, nn_table_py, etba_py, pkpts_py2, pgeom_py2, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, eig2
    implicit none
    ...
    nn_table_py2_ptr = transfer(nn_table_py2, nn_table_py2_ptr)
    etba_py2_ptr = transfer(etba_py2, etba_py2_ptr)
    call eig2(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY=pkpts_py_ptr%p, PGEOM_PY=pgeom_py_ptr%p, &
        NN_TABLE_PY=nn_table_py_ptr%p, ETBA_PY=etba_py_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p)
end subroutine f90wrap_eig2

subroutine f90wrap_eig(comm, pinpt_py, ppram_py, pkpts_py, pgeom_py, nn_table_py, etba_py)
    use pyfit, only: params_py, energy_py, eig, kpoints_py, poscar_py, hopping_py, incar_py
    implicit none
...
subroutine f90wrap_toten(comm, pinpt_py, pkpts_py, pgeom_py, etba_py)
    use pyfit, only: energy_py, kpoints_py, toten, poscar_py, incar_py
    implicit none
...
subroutine f90wrap_fit5(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py, fit5
    implicit none
...
subroutine f90wrap_fit4(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: params_py, fit4, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py
    implicit none
...
subroutine f90wrap_fit3(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    pkpts_py2, pwght_py2, pgeom_py2, nn_table_py2, edft_py2, etba_py2, pkpts_py3, pwght_py3, pgeom_py3, nn_table_py3, &
    edft_py3, etba_py3)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, fit3, weight_py
    implicit none
    ...
    edft_py3_ptr = transfer(edft_py3, edft_py3_ptr)
    etba_py3_ptr = transfer(etba_py3, etba_py3_ptr)
    call fit3(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p, PKPTS_PY3=pkpts_py3_ptr%p, &
        PWGHT_PY3=pwght_py3_ptr%p, PGEOM_PY3=pgeom_py3_ptr%p, NN_TABLE_PY3=nn_table_py3_ptr%p, EDFT_PY3=edft_py3_ptr%p, &
        ETBA_PY3=etba_py3_ptr%p)
end subroutine f90wrap_fit3
...
subroutine f90wrap_fit2(comm, pinpt_py, ppram_py, pkpts_py1, pwght_py1, pgeom_py1, nn_table_py1, edft_py1, etba_py1, &
    ...
    use pyfit, only: fit2, params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, weight_py
    implicit none
    ...
    edft_py2_ptr = transfer(edft_py2, edft_py2_ptr)
    etba_py2_ptr = transfer(etba_py2, etba_py2_ptr)
    call fit2(comm=comm, PINPT_PY=pinpt_py_ptr%p, PPRAM_PY=ppram_py_ptr%p, PKPTS_PY1=pkpts_py1_ptr%p, &
        PWGHT_PY1=pwght_py1_ptr%p, PGEOM_PY1=pgeom_py1_ptr%p, NN_TABLE_PY1=nn_table_py1_ptr%p, EDFT_PY1=edft_py1_ptr%p, &
        ETBA_PY1=etba_py1_ptr%p, PKPTS_PY2=pkpts_py2_ptr%p, PWGHT_PY2=pwght_py2_ptr%p, PGEOM_PY2=pgeom_py2_ptr%p, &
        NN_TABLE_PY2=nn_table_py2_ptr%p, EDFT_PY2=edft_py2_ptr%p, ETBA_PY2=etba_py2_ptr%p)
...
subroutine f90wrap_fit(comm, pinpt_py, ppram_py, pkpts_py, pwght_py, pgeom_py, nn_table_py, edft_py, etba_py)
    use pyfit, only: params_py, energy_py, kpoints_py, poscar_py, hopping_py, incar_py, fit, weight_py
    implicit none
...
subroutine f90wrap_init_incar_py(ifilenm, ret_pinpt_py, nsystem, n0)
    ...
    character(132), intent(in), dimension(n0) :: ifilenm
...
subroutine f90wrap_init_params_py(ret_ppram_py)
    use pyfit, only: init_params_py, params_py
    implicit none
...
subroutine f90wrap_copy_params_best(ppram_py, imode)
    use pyfit, only: params_py, copy_params_best
    implicit none
    ...
    integer(4) :: imode
    ppram_py_ptr = transfer(ppram_py, ppram_py_ptr)
    call copy_params_best(PPRAM_PY=ppram_py_ptr%p, imode=imode)
...
subroutine f90wrap_print_target(pinpt_py, pkpts_py, edft_py, pwght_py, pgeom_py, tfileoutnm)
    use pyfit, only: print_target, energy_py, kpoints_py, poscar_py, incar_py, weight_py
    implicit none
...
subroutine f90wrap_print_etba(pinpt_py, pkpts_py, etba_py, edft_py, pwght_py, pgeom_py, suffix, flag_use_overlap)
    use pyfit, only: energy_py, kpoints_py, poscar_py, incar_py, print_etba, weight_py
    implicit none
